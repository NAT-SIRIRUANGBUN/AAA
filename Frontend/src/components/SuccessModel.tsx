...
const SuccessModal: React.FC<SuccessModalProps> = ({ isOpen, onClose }) => {
    ...
    return (
      <div className="fixed inset-0 flex items-center justify-center z-50 bg-black bg-opacity-50">
        <div className="bg-white p-8 rounded-lg w-[500px] h-[500px] flex flex-col justify-center items-center">
          <div className="flex flex-col items-center space-y-4">
            ...
            <h2 className="text-xl mb-4">Your booking has been confirmed.</h2>
            <h2 className="text-xl mb-8">Check your booking on Booking page</h2>
            <button
              onClick={() => {
                window.location.reload();
                window.location.href = "/";
              }}
              className="px-8 py-2 bg-green-500 text-white rounded-lg shadow-md hover:bg-green-600 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-opacity-50"
            >
              OK
            </button>
          </div>
